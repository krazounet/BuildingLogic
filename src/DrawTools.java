...
public class DrawTools
{
    ...
    public static void drawImageCenter(BufferedImage source, BufferedImage ajout, double centerX, double centerY){
        drawImageCenter(source.getGraphics(),ajout,centerX,centerY);
    }
